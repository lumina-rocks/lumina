...
import { NostrWalletConnect } from '@/components/NostrWalletConnect';

export default function ProfileSettingsNWCPage() {
    useEffect(() => {
        document.title = `NWC Settings | LUMINA`;
    }, []);
    ...
    <div className="container mx-auto py-8 px-4 sm:px-6">
      <div className="space-y-6">
        <div className="flex flex-col space-y-2">
          <h1 className="text-3xl font-bold tracking-tight">NWC Settings</h1>
